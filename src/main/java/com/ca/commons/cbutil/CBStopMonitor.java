    ...
    public CBStopMonitor(String text, Icon icon) {
        ...
        addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (debugStopMon)
                    System.out.println("StopMon button pressed; about to stop " + ((thingToStop == null) ? "null" : thingToStop.getName()));
                stop(thingToStop);
            }
        });
    }
...
//                thingToStop.stop();
                ...
                if (debugStopMon)
                    System.out.println("StopMon interrupting thread " + ((thingToStop == null) ? "null" : thingToStop.getName() + " :" + thingToStop.isInterrupted()));
            }
            thingToStop = null;
            setEnabled(false);

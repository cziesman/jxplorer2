        ...
        dataSource.extendedRequest(new DataQuery(DataQuery.EXTENDED) {
            ...
            public void doExtendedRequest(DataBroker b) {
                ...
                try {
                    ...
                    if (usingSearch) {   // get the entries from the search tree directly; it will contain all the entries we want
                    ...
                    } else {   // read the entries from the directory - we don't know if the tree has done a complete read.

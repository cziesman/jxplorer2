...
public class LdifUtilityTest {
    ...
    @Test
    public void testBase64Decoding2() throws Exception {
...
//        String base64Text = "";
    ...
    public void testLdifEncoding() {
        ...
        Assertions.assertEquals("bloop: " + attVal1 + "\n", ldifVal1);

        // note use of ldif hack
        String ldifVal2 = utility.ldifEncode("bloop", attVal2);
        Assertions.assertEquals("bloop:: Ymxvb3B5CmJsb29weQpibG9vcHkK\n", ldifVal2);

        String ldifVal3 = utility.ldifEncode("bloop", attVal3);
        Assertions.assertEquals("bloop:: IHNub3J0IA==\n", ldifVal3);
    }

    @Test
    public void testLdifDecoding() throws NamingException {

        String attVal1 = "description: fnord";
        String attVal2 = "description: bloopy\nbloopy\nbloopy\n";

        Object[] attValPair = utility.ldifDecodeAttribute(attVal1);
        Assertions.assertEquals("description", attValPair[0]);
        Assertions.assertEquals("fnord", attValPair[1]);

        attValPair = utility.ldifDecodeAttribute(attVal2);
        Assertions.assertEquals("description", attValPair[0]);
        Assertions.assertEquals("bloopy\nbloopy\nbloopy\n", attValPair[1]);
    }
    ...
    @Test
    public void testLdifDecodingAsBinary() throws NamingException {

        Object[] attValPair = utility.ldifDecodeAttribute("bloop:: IHNub3J0IA==\n");
        Assertions.assertEquals("bloop", attValPair[0]);
        Assertions.assertEquals(" snort ", attValPair[1]);
        ...
        Assertions.assertEquals(base64text, encodedText);
    ...
    @Test
    public void testLdifEncodeEntry2() throws Exception {
        ...
        Assertions.assertEquals(expectedLdif, ldifEntry);
    }

    @Test
    public void testLdifEncodeEntry() throws Exception {
    ...
    @Test
    public void testLdifDecodeEntry() throws Exception {
        ...
        Assertions.assertEquals("cn=Admin,ou=users,o=groupmind,c=au", entry1.getDN().toString());
        Assertions.assertEquals("97", entry1.getString("uid"));
        Assertions.assertEquals("admin", entry1.getString("groupmindRole"));
        Assertions.assertEquals("10 Ramage road\nMount Eliza\nQueensland\n4000", entry1.getString("userAddress"));

        DXEntry entry2 = utility.readLdifEntry(reader);

        Assertions.assertEquals("cn=Fred,ou=users,o=groupmind,c=au", entry2.getDN().toString());
        Assertions.assertEquals("98", entry2.getString("uid"));
        Assertions.assertEquals("user", entry2.getString("groupmindRole"));
    }
    ...
    public void testLdifDecodeEntry2() throws Exception {
        ...
        Assertions.assertEquals("cn=Test Area,cn=blog,cn=Chris,cn=topics,o=groupmind,c=au", entry1.getDN().toString());
        Assertions.assertEquals(result, entry1.getString("description"));
    }
